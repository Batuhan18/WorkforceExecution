...
## Offline / Kesinti Dayanikliligi
- **Cihaz kapanirsa (sarj/elektrik):** Gun sonu (fact) formu her tus vurusunda localStorage'a taslak olarak yazilir; modal tekrar acildiginda form taslaktan dolar. JWT suresi bittiyse yeniden login sonrasi taslak yine durur.
- **Sunucuya ulasilamazsa:** Fact gonderimi localStorage'daki offline kuyruga alinir; 'online' event'i, 45 sn'lik periyodik kontrol, sayfa acilisi ve SignalR yeniden baglanma aninda otomatik yeniden denenir.
- **Sunucu kayit aninda cokerse:** EF Core SaveChanges tek transaction'dir; SQL Server transaction log'u yarim yazimi engeller. Kuyruktan gelen mukerrer istek durum makinesince reddedilir.
